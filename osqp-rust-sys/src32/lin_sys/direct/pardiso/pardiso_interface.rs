...
pub const MKL_INTERFACE_LP64: ::std::os::raw::c_int = 0 as ::std::os::raw::c_int;
...
pub unsafe extern "C" fn free_linsys_solver_pardiso(mut s: *mut pardiso_solver) {
    if !s.is_null() {
        ...
        if (*s).error != 0 as ::std::os::raw::c_int {
            printf(
...
pub unsafe extern "C" fn init_linsys_solver_pardiso(
    ...
    *fresh4 = malloc(
        (::std::mem::size_of::<c_float>() as ::std::os::raw::c_ulong)
            .wrapping_mul(n_plus_m as ::std::os::raw::c_ulong),
    ) as *mut c_float;
    ...
    *fresh6 = malloc(
    ...
    if polish != 0 {
        ...
        *fresh8 = malloc(
            (*((*P).p).offset((*P).n as isize) as ::std::os::raw::c_ulong)
                .wrapping_mul(::std::mem::size_of::<c_int>() as ::std::os::raw::c_ulong),
        ) as *mut c_int;
        let ref mut fresh9 = (*s).AtoKKT;
        *fresh9 = malloc(
            (*((*A).p).offset((*A).n as isize) as ::std::os::raw::c_ulong)
                .wrapping_mul(::std::mem::size_of::<c_int>() as ::std::os::raw::c_ulong),
        ) as *mut c_int;
        let ref mut fresh10 = (*s).rhotoKKT;
        *fresh10 = malloc(
            ((*A).m as ::std::os::raw::c_ulong)
                .wrapping_mul(::std::mem::size_of::<c_int>() as ::std::os::raw::c_ulong),
        ) as *mut c_int;
        i = 0 as ::std::os::raw::c_int;
        while i < (*A).m {
    ...
    if ((*s).KKT).is_null() {
        ...
        return OSQP_LINSYS_SOLVER_INIT_ERROR as ::std::os::raw::c_int;
    } else {
        nnzKKT = *((*(*s).KKT).p).offset((*(*s).KKT).m as isize);
        let ref mut fresh12 = (*s).KKT_i;
        *fresh12 = malloc(
            (nnzKKT as ::std::os::raw::c_ulong)
                .wrapping_mul(::std::mem::size_of::<c_int>() as ::std::os::raw::c_ulong),
        ) as *mut c_int;
        let ref mut fresh13 = (*s).KKT_p;
        *fresh13 = malloc(
            (((*(*s).KKT).m + 1 as ::std::os::raw::c_int) as ::std::os::raw::c_ulong)
                .wrapping_mul(::std::mem::size_of::<c_int>() as ::std::os::raw::c_ulong),
        ) as *mut c_int;
        i = 0 as ::std::os::raw::c_int;
        while i < nnzKKT {
            *((*s).KKT_i)
                .offset(
                    i as isize,
                ) = *((*(*s).KKT).i).offset(i as isize) + 1 as ::std::os::raw::c_int;
            i += 1;
        }
        i = 0 as ::std::os::raw::c_int;
        while i < n_plus_m + 1 as ::std::os::raw::c_int {
            *((*s).KKT_p)
                .offset(
                    i as isize,
                ) = *((*(*s).KKT).p).offset(i as isize) + 1 as ::std::os::raw::c_int;
            i += 1;
        }
    }
    mkl_set_interface_layer(MKL_INTERFACE_LP64);
    (*s).mtype = -(2 as ::std::os::raw::c_int);
    (*s).nrhs = 1 as ::std::os::raw::c_int;
    (*s).maxfct = 1 as ::std::os::raw::c_int;
    (*s).mnum = 1 as ::std::os::raw::c_int;
    (*s).msglvl = 0 as ::std::os::raw::c_int;
    (*s).error = 0 as ::std::os::raw::c_int;
    i = 0 as ::std::os::raw::c_int;
    while i < 64 as ::std::os::raw::c_int {
        (*s).iparm[i as usize] = 0 as ::std::os::raw::c_int;
        let ref mut fresh14 = (*s).pt[i as usize];
        *fresh14 = 0 as *mut ::std::os::raw::c_void;
        i += 1;
    }
    (*s).iparm[0 as ::std::os::raw::c_int as usize] = 1 as ::std::os::raw::c_int;
    (*s).iparm[1 as ::std::os::raw::c_int as usize] = 3 as ::std::os::raw::c_int;
    if polish != 0 {
        (*s).iparm[5 as ::std::os::raw::c_int as usize] = 1 as ::std::os::raw::c_int;
    } else {
        (*s).iparm[5 as ::std::os::raw::c_int as usize] = 0 as ::std::os::raw::c_int;
    }
    (*s).iparm[7 as ::std::os::raw::c_int as usize] = 0 as ::std::os::raw::c_int;
    (*s).iparm[9 as ::std::os::raw::c_int as usize] = 13 as ::std::os::raw::c_int;
    (*s).iparm[34 as ::std::os::raw::c_int as usize] = 0 as ::std::os::raw::c_int;
