...
pub unsafe extern "C" fn amd_aat(
    ...
    let mut nzdiag: ::std::os::raw::c_int = 0;
    let mut nzboth: ::std::os::raw::c_int = 0;
    ...
    while k < n {
        *Len.offset(k as isize) = 0 as ::std::os::raw::c_int;
        k += 1;
    }
    nzdiag = 0 as ::std::os::raw::c_int;
    nzboth = 0 as ::std::os::raw::c_int;
    ...
    k = 0 as ::std::os::raw::c_int;
    while k < n {
        nzaat = (nzaat as ::std::os::raw::c_ulong)
            .wrapping_add(*Len.offset(k as isize) as ::std::os::raw::c_ulong) as size_t as size_t;
        k += 1;
    }
    if !Info.is_null() {
        *Info.offset(AMD_STATUS as isize) = AMD_OK as c_float;
