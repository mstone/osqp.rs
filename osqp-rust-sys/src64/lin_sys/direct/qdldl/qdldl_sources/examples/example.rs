...
#[no_mangle]
pub static mut An: QDLDL_int = 10 as ::std::os::raw::c_int as QDLDL_int;
#[no_mangle]
pub static mut Ap: [QDLDL_int; 11] = [
    0 as ::std::os::raw::c_int as QDLDL_int,
    1 as ::std::os::raw::c_int as QDLDL_int,
    2 as ::std::os::raw::c_int as QDLDL_int,
    4 as ::std::os::raw::c_int as QDLDL_int,
    5 as ::std::os::raw::c_int as QDLDL_int,
    6 as ::std::os::raw::c_int as QDLDL_int,
    8 as ::std::os::raw::c_int as QDLDL_int,
    10 as ::std::os::raw::c_int as QDLDL_int,
    12 as ::std::os::raw::c_int as QDLDL_int,
    14 as ::std::os::raw::c_int as QDLDL_int,
    17 as ::std::os::raw::c_int as QDLDL_int,
];
#[no_mangle]
pub static mut Ai: [QDLDL_int; 17] = [
    ...
    1 as ::std::os::raw::c_int as QDLDL_int,
    2 as ::std::os::raw::c_int as QDLDL_int,
    3 as ::std::os::raw::c_int as QDLDL_int,
    4 as ::std::os::raw::c_int as QDLDL_int,
    1 as ::std::os::raw::c_int as QDLDL_int,
    5 as ::std::os::raw::c_int as QDLDL_int,
    0 as ::std::os::raw::c_int as QDLDL_int,
    6 as ::std::os::raw::c_int as QDLDL_int,
    3 as ::std::os::raw::c_int as QDLDL_int,
    7 as ::std::os::raw::c_int as QDLDL_int,
    6 as ::std::os::raw::c_int as QDLDL_int,
    8 as ::std::os::raw::c_int as QDLDL_int,
    1 as ::std::os::raw::c_int as QDLDL_int,
    2 as ::std::os::raw::c_int as QDLDL_int,
    9 as ::std::os::raw::c_int as QDLDL_int,
];
#[no_mangle]
...
unsafe fn main_0() -> ::std::os::raw::c_int {
    ...
    etree = malloc(
        (::std::mem::size_of::<QDLDL_int>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(An as ::std::os::raw::c_ulonglong) as ::std::os::raw::c_ulong,
    ) as *mut QDLDL_int;
    Lnz = malloc(
        (::std::mem::size_of::<QDLDL_int>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(An as ::std::os::raw::c_ulonglong) as ::std::os::raw::c_ulong,
    ...
    Lp = malloc(
        (::std::mem::size_of::<QDLDL_int>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(
                (An + 1 as ::std::os::raw::c_int as ::std::os::raw::c_longlong) as ::std::os::raw::c_ulonglong,
    ...
    iwork = malloc(
        (::std::mem::size_of::<QDLDL_int>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(
                (3 as ::std::os::raw::c_int as ::std::os::raw::c_longlong * An) as ::std::os::raw::c_ulonglong,
            ) as ::std::os::raw::c_ulong,
    ) as *mut QDLDL_int;
    bwork = malloc(
    ...
    Li = malloc(
        (::std::mem::size_of::<QDLDL_int>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(sumLnz as ::std::os::raw::c_ulonglong) as ::std::os::raw::c_ulong,
    ) as *mut QDLDL_int;
    Lx = malloc(
        (::std::mem::size_of::<QDLDL_float>() as ::std::os::raw::c_ulong as ::std::os::raw::c_ulonglong)
            .wrapping_mul(sumLnz as ::std::os::raw::c_ulonglong) as ::std::os::raw::c_ulong,
    ...
    print_arrayi(
        Ap.as_ptr(),
        An + 1 as ::std::os::raw::c_int as ::std::os::raw::c_longlong,
    ...
    print_arrayi(
        Lp,
        Ln + 1 as ::std::os::raw::c_int as ::std::os::raw::c_longlong,
